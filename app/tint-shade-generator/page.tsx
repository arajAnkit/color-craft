...
export default function TintShadeGeneratorPage() {
  ...
  const generateTints = (color: string, count: number) => {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      const hexTint = `#${rTint.toString(16).padStart(2, "0")}${gTint
        .toString(16)
        .padStart(2, "0")}${bTint.toString(16).padStart(2, "0")}`;
      tints.push(hexTint);
    }
    return tints;
  };
  ...
  const generateShades = (color: string, count: number) => {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      const hexShade = `#${rShade.toString(16).padStart(2, "0")}${gShade
        .toString(16)
        .padStart(2, "0")}${bShade.toString(16).padStart(2, "0")}`;
  ...
  const generateTones = (color: string, count: number) => {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      const hexTone = `#${rTone.toString(16).padStart(2, "0")}${gTone
        .toString(16)
        .padStart(2, "0")}${bTone.toString(16).padStart(2, "0")}`;
      tones.push(hexTone);
    }
    return tones;
  };
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
      {colors.map((color, index) => (
        ...
        >
          ...
          <span className="mt-1 text-xs font-mono text-muted-foreground group-hover:text-foreground">
            {color}
          </span>
        </button>
      ))}
    ...
    <div className="container max-w-6xl mx-auto px-6 py-10">
      <div className="flex flex-col gap-2 mb-8">
        ...
        <p className="text-lg text-muted-foreground">
          Create lighter tints, darker shades, and muted tones from any base
          color.
        </p>
      </div>
            ...
            <Tabs defaultValue="tints">
              ...
              <TabsContent value="tints" className="space-y-4 pt-4">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Lighter, more pastel versions of your base color
                  </p>
                </div>
              ...
              <TabsContent value="shades" className="space-y-4 pt-4">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Darker, more intense versions of your base color
                  </p>
                </div>
              ...
              <TabsContent value="tones" className="space-y-4 pt-4">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Muted, sophisticated versions of your base color
                  </p>
                </div>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            View your full color range from darkest to lightest
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Learn how to use color variations effectively in your designs
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="bg-muted rounded-lg p-6 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Primary:</strong> Use your base color for main
                    actions
                  </li>
                  <li>
                    <strong>Secondary:</strong> Use tints for supporting
                    elements
                  </li>
                  <li>
            ...
            <div className="bg-background rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground">
                Create a balanced design system with 3-5 tints, 3-5 shades, and
                2-3 tones of your primary colors. This gives you enough
                variation for different UI states while maintaining visual
                harmony. Tones are particularly useful for creating
                sophisticated, professional interfaces that aren't too vibrant.
              </p>
            </div>
          </div>
        </CardContent>
