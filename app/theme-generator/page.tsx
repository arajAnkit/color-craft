...
${darkVars}
  ...
  const UIPreview = ({ theme }: { theme: Record<string, string> }) => (
    <div
      className="space-y-4"
      style={{ background: theme.background, color: theme.foreground, padding: "1rem", borderRadius: "0.5rem" }}
    >
  ...
  return (
    <div className="container max-w-6xl mx-auto px-6 py-10">
      <div className="flex flex-col gap-2 mb-8">
        <h1 className="text-3xl font-bold tracking-tighter md:text-4xl">Theme Generator</h1>
        <p className="text-lg text-muted-foreground">Generate CSS variables for Tailwind CSS V4 themes.</p>
      </div>
        ...
        <Card className="md:col-span-1">
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-col gap-4">
              <div className="h-24 rounded-md shadow-md" style={{ backgroundColor: primaryColor }}></div>
              ...
              <Button variant="outline" onClick={randomizeColor} className="w-full gap-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Copy these CSS variables for use with Tailwind CSS V4</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button onClick={() => copyToClipboard(generateTailwindV4Variables())} className="w-full gap-2">
            <Copy className="h-4 w-4" />
      ...
      <Card className="mt-8">
        <CardHeader>
          ...
          <CardDescription>How to implement your generated theme</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Copy the generated CSS variables and add them to your main CSS file:
              </p>
...
:root {
  ...
  /* ... rest of your variables */
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">Reference the colors in your Tailwind classes:</p>
              <pre className="text-xs bg-muted p-3 rounded-md overflow-x-auto">
...
<div className="bg-card text-card-foreground border border-border">
  Card Content
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">
                The generated variables include both light and dark themes. Use class-based or system preference dark
                mode:
              </p>
              <pre className="text-xs bg-muted p-3 rounded-md overflow-x-auto">
